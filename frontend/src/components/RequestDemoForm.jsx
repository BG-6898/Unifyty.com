...
import { X, Building2, Mail, Phone, User, Briefcase, Calendar } from 'lucide-react';
import { Button } from './ui/button';
import { Card, CardContent, CardHeader } from './ui/card';

const RequestDemoForm = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm animate-fade-in">
      <Card className="relative w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto bg-slate-900/95 border-slate-700 shadow-2xl animate-scale-in">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <CardHeader className="p-8 pb-6">
          ...
          <p className="text-slate-400">
            See how UNIFYTY can transform your security operations. Our team will reach out to schedule a personalized demo.
          </p>
        </CardHeader>
        ...
        <CardContent className="p-8 pt-0">
          {submitSuccess ? (
            <div className="text-center py-12">
              ...
              <p className="text-slate-400">Our team will contact you shortly to schedule your personalized demo.</p>
            </div>
          ) : (
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-10 pr-4 py-3 bg-slate-800/50 border border-slate-700 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all"
                      placeholder="CISO / Security Director"
                    />
                  </div>
                </div>
              </div>

              {/* Phone and Team Size Row */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Phone Number */}
                <div>
